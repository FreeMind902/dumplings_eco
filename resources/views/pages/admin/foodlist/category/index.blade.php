          ...
          <div class="card-header">
            <div class="row">
              <div class="col-6 mt-2">
                <h3>Übersicht Speisekarten Kategorien</h3>
              </div>
              <div class="col-6">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                @if (isset($foodListCategories))
                  @foreach($foodListCategories as $category)
{{--                    @dd($category)--}}

                    <div class="row">
                      <tr>
                        <td class="col">{{$category->id}}</td>
                        <td class="col">{{$category->context_type_de}}</td>
                        <td class="col">{{$category->label_de}}</td>
                        <td class="col-3">
                          <a class="text-decoration-none" href="{{route('admin.foodlist.category.create',['id' => $category->id ])}}">
