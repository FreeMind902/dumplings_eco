<footer class="footer">
  ...
  {{--        --}}
  {{--        <span class=""><b>Dumplings gmbh</b></span>--}}
  {{--        <hr class="footer-hr">--}}
  {{--        <span>--}}
  ...
  {{--          <span>--}}
  {{--           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path--}}
  {{--               d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>--}}
  {{--          </span>--}}
  {{--          <span>Musterstraße 123, 12121 Berlin</span>--}}
  {{--        </div>--}}
  {{--        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2">--}}
  {{--          <span>--}}
  ...
  <div class="container-fluid">
    <div class="row bg-secondary text-center">
      <p class="text-white mt-3">Copyright Dumplings © 2021</p>
    </div>
  </div>
</footer>
